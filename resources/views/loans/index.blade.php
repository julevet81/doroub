...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto" style="font-size: xx-large"> الاعارات</h4>
			</div>
		</div>
										...
										@foreach($loans as $loan)
											<tr>
												...
												<td>
													...
													@endif
												<td>
													<a class="modal-effect btn btn-sm btn-success" href="{{ route('loans.show', $loan->id) }}">عرض<i class="las la-pen"></i></a>
													<a class="modal-effect btn btn-sm btn-info"  href="{{ route('loans.edit', $loan->id) }}">تعديل<i class="las la-pen"></i></a>
													<a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" href="#delete{{$loan->id}}">حذف<i class="las la-trash"></i></a>
												</td>
												<td></td>
											</tr>
