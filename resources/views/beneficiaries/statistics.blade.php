...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1" style="font-size: xx-large">إحصائيات المستفيدين</h2>
						  <br>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden sales-card bg-primary-gradient">
						<div class="pl-3 pr-3 pb-2 pt-0">
							<br>
							<div class="">
								<h6 class="mb-3 tx-12 text-white" style="font-size: x-large">اجمالي المتطوعين</h6>
							</div>
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
					...
					<div class="card overflow-hidden sales-card bg-danger-gradient">
						<div class="pl-3 pr-3 pb-2 pt-0">
							...
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
										<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ \App\Models\Beneficiary::count() }}</h4>
				...
				<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden sales-card bg-success-gradient">
						<div class="pl-3 pr-3 pb-2 pt-0">
							<div class="">
								<br>
								<h6 class="mb-3 tx-12 text-white" style="font-size: x-large">إجمالي المتبرعين</h6>
							</div>
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
					<div class="card overflow-hidden sales-card bg-warning-gradient">
						<div class="pl-3 pr-3 pb-2 pt-0">
							<div class="">
								<br>
								<h6 class="mb-3 tx-12 text-white" style="font-size: x-large">إجمالي الإستفادات</h6>
							</div>
							<div class="pb-0 mt-0">
								<div class="d-flex">
									<div class="">
					...
					<div class="card">
						<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
							<div class="d-flex justify-content-between">
								<h4 class="card-title mb-0" style="font-size: x-large">احصائيات المشاريع</h4>
						...
						<div class="card-body">
							<div class="total-revenue">
								<div>
								  <h4>{{ App\Models\Project::where('status', 'completed')->count() }}</h4>
								  <label style="font-size: large"><span class="bg-primary"></span>المشاريع المنجزة</label>
								</div>
								<div>
								  <h4>{{ App\Models\Project::where('status', 'planned')->count() }}</h4>
								  <label style="font-size: large"><span class="bg-danger"></span>المشاريع قيد الانتظار</label>
								</div>
								<div>
								  <h4>{{ App\Models\Project::where('status', 'in_progress')->count() }}</h4>
								  <label style="font-size: large"><span class="bg-warning"></span>المشاريع قيد التنفيذ</label>
								</div>
							  </div>
