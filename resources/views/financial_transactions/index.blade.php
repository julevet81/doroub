	...
	<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
		<div class="card overflow-hidden sales-card bg-primary-gradient">
			<div class="pl-3 pr-3 pb-2 pt-0">
				<br>
				<div class="">
					<h6 class="mb-3 tx-12 text-white" style="font-size: x-large"> عدد الايرادات</h6>
				</div>
				<div class="pb-0 mt-0">
					<div class="d-flex">
						<div class="">
							<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ \App\Models\FinancialTransaction::where('transaction_type', 'income')->count() }}</h4>
						</div>
	...
	<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
		<div class="card overflow-hidden sales-card bg-danger-gradient">
			<div class="pl-3 pr-3 pb-2 pt-0">
				<div class="">
					<br>
					<h6 class="mb-3 tx-12 text-white" style="font-size: x-large">  الايرادات الكلية</h6>
				</div>
				<div class="pb-0 mt-0">
					<div class="d-flex">
						<div class="">
							<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ \App\Models\FinancialTransaction::where('transaction_type', 'income')->sum('amount') }}</h4>
						</div>
						<span class="float-right my-auto mr-auto">
	...
	<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
		<div class="card overflow-hidden sales-card bg-success-gradient">
			<div class="pl-3 pr-3 pb-2 pt-0">
				<div class="">
					<br>
					<h6 class="mb-3 tx-12 text-white" style="font-size: x-large"> إيرادات المشاريع الكلية</h6>
				</div>
				<div class="pb-0 mt-0">
					<div class="d-flex">
						<div class="">
							<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ \App\Models\FinancialTransaction::where('transaction_type', 'expense')->where('orientation', 'project')->sum('amount') }}</h4>
						</div>
						<span class="float-right my-auto mr-auto">
							<i class="fas fa-arrow-circle-up text-white"></i>
						</span>
