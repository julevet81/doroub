...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto" style="font-size: xx-large"> الاستفادات</h4>
			</div>
		</div>
					...
					<div class="card mg-b-20">
						<div class="card-header pb-0">
							<div class="d-flex justify-content-between">
								...
								<a href="{{ route('benefices.create') }}" class="btn btn-primary" style="font-size: x-large">
									إضافة استفادة
								</a>
							</div>
						</div>
								...
								<table id="example" class="table key-buttons text-md-nowrap">
									...
									<tbody>
										@foreach($benefices as $benefice)
											<tr>
												<td>{{ $benefice->id }}</td>
												<td>{{ $benefice->beneficiary->full_name }}</td>
												<td>
